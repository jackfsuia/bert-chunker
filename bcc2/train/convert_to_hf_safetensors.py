...
file_path = r"/data/bc-chinese-2/newline_750k/checkpoint-115200/model.safetensors"
...
save_file(new_state_dict, r"/data/bc-chinese-2/model.safetensors", metadata=metadata)
...
model_path = r"D:\github-my-project\bert-chunker-Chinese-2\bc-chinese-2-hf"
...
dec3=r'''起点中文网(www.qidian.com)创立于2002年5月，是国内知名的原创\n\n文学 网站，隶属于阅文集团  \n  旗下。起点中文 网以推动中国  原创文学事业为宗旨，长期致力于原创文学作者的挖掘与培养，并取得了巨大成果：2003年10月，起点中文网开启“在线收费阅读”服务，成为真正意义上的网络文学赢利模式的先锋之一，就此奠定了原创文学的行业基础。此后，起点又推出了作家福利、文学交互、内容发掘推广、版权管理等机制和体系，为原创文学的发展注入了巨大活力，有力推动了中国文学原创事业的发展。在清晨的微光中，一只孤独的猫头鹰在古老的橡树上低声吟唱，它的歌声如同夜色的回声，穿越了时间的迷雾。树叶在微风中轻轻摇曳，仿佛在诉说着古老的故事，每一个音符都带着 森林  的秘密。一位年轻的程序员正专注地敲打着键盘，代码的海洋在他眼前展开。他的手指在键盘上飞舞，如同钢琴家在演奏一曲复杂的交响乐。屏幕上的光标闪烁，仿佛在等待着下一个指令，引领他进入未知的数字世界。'''
dec2=r'''云南丽江市文化和旅游局等多个部门2月27日发布《关于整治客栈民宿非法组织旅游活动的通告》。

整治范围包括：未取得旅行社业务经营许可证，擅自从事旅行社业务的客栈、民宿；以“自由行”定制游”等名义非法提供包车、导游景区门票等旅游服务的客栈、民宿；以代订玉龙雪山冰川公园索道票等虚假宣传方式招揽游客，非法组织旅游活动的客栈、民宿;其他违反旅游相关法律法规，非法组织旅游活动。

整治重点包括：打击非法从事旅行社业务的行为；整治“拉客、揽客”行为；整治非法倒票行为；整治虚假宣传、价格欺诈、商业贿赂等行为；整治非法营运行为。

当地还提供有奖举报，鼓励社会各界和广大游客积极举报客栈、民宿非法组织旅游活动的行为。'''
d3=r'''类提供了把数据和功能绑定在一起的方法。创建新类时创建了新的对象 *类型*
...
chunks, token_pos = chunk_text(model, d3+dec2, tokenizer, prob_threshold=0.5)
